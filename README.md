...
- **Science-based body goals** — deterministic adult calorie/macronutrient estimates and BMI screening context; [methodology and evidence](docs/health-target-methodology.md)
