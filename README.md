...
- **Science-based body goals** — newest body reading stays authoritative; deterministic adult calorie/macronutrient estimates include bounded or maintenance weight milestones, quality-gated smart-scale trend personalization, bounded AI-assisted choices, activity guidance, and BMI screening context; [methodology and evidence](docs/health-target-methodology.md)
